...
description: "Spectra Portal is a standalone DApp that extends the functionality of the Spectra Explorer. This DApp provides an interface that grants users a way to bridge tokens across different chains using the Inter Blockchain Communication Protocol, and swap tokens across different chains using the Osmosis DEX."
---
# The Spectra 💫 Portal

This is only the initial documentation present from the github. Until more detailed documentation is better to check
...
This will build the images locally and start the services.
