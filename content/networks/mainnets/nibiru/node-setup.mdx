...
wget https://go.dev/dl/gogo1.25.0.linux-amd64.tar.gz
sudo tar -C /usr/local -xzf gogo1.25.0.linux-amd64.tar.gz
rm gogo1.25.0.linux-amd64.tar.gz
...
cd nibiru v2.17.0 # always doublecheck from the official team for the right version
git checkout 
make install
```
...
- [Stavr](https://stavr-team.gitbook.io/nodes-guides/mainnets/nibiru/statesync-snapshot)
```
