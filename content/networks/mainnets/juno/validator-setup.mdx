---
title: "Validator setup for Juno Network"
description: "Validator setup for Juno Network"
---
...
junod tx staking create-validator ./validator.json \
--chain-id= juno-1 \
--from= #keyname \
--gas= "auto" \
