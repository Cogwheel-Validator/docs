...
```bash
atomoned tx distribution withdraw-all-rewards --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```

#### Withdraw commission and rewards from your validator

```bash
atomoned tx distribution withdraw-rewards $( atomoned keys show wallet --bech val -a) --commission --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```

#### Delegate tokens to yourself

```bash
atomoned tx staking delegate $( atomoned keys show wallet --bech val -a) 100000000000 --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```

#### Delegate tokens to validator

```bash
atomoned tx staking delegate <TO_VALOPER_ADDRESS> 100000000000 --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices   -y
```

#### Redelegate tokens to another validator

```bash
atomoned tx staking redelegate $( atomoned keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000$ublit --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```

#### Unbond tokens from your validator

```bash
atomoned tx staking unbond $( atomoned keys show wallet --bech val -a) 1000000$ublit --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```

#### Send tokens to the wallet

```bash
atomoned tx bank send wallet <TO_WALLET_ADDRESS> 1000000$ublit --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```
...
```bash
atomoned tx gov vote 1 yes --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```

#### Vote 'No'

```bash
atomoned tx gov vote 1 no --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```

#### Vote 'Abstain'

```bash
atomoned tx gov vote 1 abstain --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```

#### Vote 'NoWithVeto'

```bash
atomoned tx gov vote 1 NoWithVeto --from wallet --chain-id atomone-1 --gas-adjustment 1.5 --gas auto --gas-prices  -y
```
