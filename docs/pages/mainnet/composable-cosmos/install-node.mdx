...
git checkout v6.5.30 # always doublecheck from the official team for the right version
make install
```
...
wget https://raw.githubusercontent.com/Cogwheel-Validator/docs/main/files/composable/genesis.json -O $HOME/.banksy/config/genesis.json
wget https://raw.githubusercontent.com/Cogwheel-Validator/docs/main/files/composable/addrbook.json -O $HOME/.banksy/config/addrbook.json
