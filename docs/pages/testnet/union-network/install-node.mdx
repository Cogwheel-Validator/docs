...
wget -O - https://github.com/Cogwheel-Validator/docs/raw/main/files/union-testnet/uniond-v0.19.0-linux-amd64.tar.gz | tar -xz -C $HOME/.union/cosmovisor/genesis/bin/
...
uniond init YOUR_MONIKER --chain-id union-testnet-6 --home=$HOME/.union/
