# Node setup for Blit Chain - Testnet
...
```bash
export BLIT_VERSION=$(curl https://blit-testnet-api.cogwheel.zone/cosmos/base/tendermint/v1beta1/node_info | jq -r .application_version.version)
