...
```bash
junod tx slashing unjail --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto
...
```bash
junod tx distribution withdraw-all-rewards --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```

#### Withdraw commission and rewards from your validator

```bash
junod tx distribution withdraw-rewards $( junod keys show wallet --bech val -a) --commission --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```

#### Delegate tokens to yourself

```bash
junod tx staking delegate $( junod keys show wallet --bech val -a) 1000000ujunox --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```

#### Delegate tokens to validator

```bash
junod tx staking delegate <TO_VALOPER_ADDRESS> 1000000ujunox --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox  -y
```

#### Redelegate tokens to another validator

```bash
junod tx staking redelegate $( junod keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000ujunox --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```

#### Unbond tokens from your validator

```bash
junod tx staking unbond $( junod keys show wallet --bech val -a) 1000000ujunox --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```

#### Send tokens to the wallet

```bash
junod tx bank send wallet <TO_WALLET_ADDRESS> 1000000ujunox --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```
...
```bash
junod tx gov vote 1 yes --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```

#### Vote 'No'

```bash
junod tx gov vote 1 no --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```

#### Vote 'Abstain'

```bash
junod tx gov vote 1 abstain --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```

#### Vote 'NoWithVeto'

```bash
junod tx gov vote 1 NoWithVeto --from wallet --chain-id uni-6 --gas-adjustment 1.5 --gas auto --gas-prices 0.075ujunox -y
```
