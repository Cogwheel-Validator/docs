...
# Node setup for Composable Cosmos chain - Testnet
...
git checkout v6.4.88 # always doublecheck from the official team for the right version
make install
```
...
centaurid init YOUR_MONIKER --chain-id banksy-testnet-5
